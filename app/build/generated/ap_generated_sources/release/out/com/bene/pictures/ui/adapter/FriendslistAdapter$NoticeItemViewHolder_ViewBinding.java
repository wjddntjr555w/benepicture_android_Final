...
public class FriendslistAdapter$NoticeItemViewHolder_ViewBinding implements Unbinder {
  private FriendslistAdapter.NoticeItemViewHolder target;

  @UiThread
  public FriendslistAdapter$NoticeItemViewHolder_ViewBinding(FriendslistAdapter.NoticeItemViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FriendslistAdapter.NoticeItemViewHolder target = this.target;
